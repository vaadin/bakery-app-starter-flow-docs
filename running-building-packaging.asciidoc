...
To run tests on multiple browser Selenium hub follow the link:https://vaadin.com/docs/v13/testbench/testbench-running-test-on-multiple-browsers.html[Running Tests on Multiple Browsers in a Grid].
