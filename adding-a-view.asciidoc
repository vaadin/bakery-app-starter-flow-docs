...
You can control the view navigation logic by implementing `BeforeEnterObserver` or `BeforeLeaveObserver`. More about link:https://github.com/vaadin/flow-and-components-documentation/blob/master/routing/tutorial-routing-lifecycle.asciidoc[navigation lifecycle].
...
Read more about link:https://github.com/vaadin/flow-and-components-documentation/blob/master/polymer-templates/tutorial-template-bindings.asciidoc[binding Model Data in a PolymerTemplate]
