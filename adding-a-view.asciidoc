...
You can control the view navigation logic by implementing `BeforeEnterObserver` or `BeforeLeaveObserver`. More about link:https://vaadin.com/docs/v13/flow/routing/tutorial-routing-lifecycle.html[navigation lifecycle].
...
Read more about link:https://vaadin.com/docs/v13/flow/polymer-templates/tutorial-template-bindings.html[binding Model Data in a PolymerTemplate]
